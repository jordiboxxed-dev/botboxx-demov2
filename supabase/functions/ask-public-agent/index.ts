...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Public Webhook Response Status:', webhookResponse.status);
    console.log('Public Webhook Response Content-Type:', webhookResponse.headers.get('Content-Type'));
    ...
    console.log('Public Webhook raw response body:', responseBodyText);
