  ...
  try {
    ...
    try {
        ...
        if (responseData.output && typeof responseData.output === 'string') {
            ...
            console.warn("La respuesta del webhook es JSON pero no tiene el formato { output: '...' }. Se devolverá el JSON completo.");
            responseText = JSON.stringify(responseData, null, 2);
        }
    } catch (e) {
        console.log("La respuesta del webhook no es JSON. Se tratará como texto plano.");
